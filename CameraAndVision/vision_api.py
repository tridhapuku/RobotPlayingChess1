...
def TakeImageUsingOpenCV(count):
    ...
    camera_id = 0  # change the value to select the desired camera -- logitech
...
if __name__ == "__main__":
    TakeImageUsingOpenCV(3)
    SplitImage("CameraAndVision\data\captured_live_images\captured_image3.jpg")
